...
Date=['22-22-3636']
Time=['22:22:22']
# maximum number of bikes parking available
bikes=100
# maximum number of cars parking available
cars=250
# maximum number of bicycles parking available
bicycles=78
# main function(driver function)
def main():
    # these 3 variables declared as global varible
    ...
    try:
        while True:
            ...
            # if user enter choice 1 then it is used for parking entry
            if ch==1:
                no=True
                while no==True:
                ...
                while no==True:
                    ...
                    if Vno=="":
                        ...
                        print("###### Enter Valid Vehicle Number ######")
            # here we put a condition to check the parked vechiles
            elif ch==3:
                count=0
                print("----------------------------------------------------------------------------------------------------------------------")
            ...
            # here we check the availability of parking space of all vechiles
            elif ch==4:
                print("----------------------------------------------------------------------------------------------------------------------")
            ...
            # here we show the price of every kind of vechile
            elif ch==5:
                print("----------------------------------------------------------------------------------------------------------------------")
                print("\t\t\t\tParking Rate")
                print("----------------------------------------------------------------------------------------------------------------------")
